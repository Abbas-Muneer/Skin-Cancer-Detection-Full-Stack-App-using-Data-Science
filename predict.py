...
from db import get_disease_details
...
infection_CLASSES = ['Acne', 'Atopic_Dermatitis', 'Basal_Cell_Carcinoma', 'Eczema', 'Melanocytic_Nevi', 'Melanoma',
                     'Nail Fungus', 'Psoriasis', 'Serorrheic Keratoses', 'Skin_Cancer', 'Tinea Ringworm Candideas',
                     'Warts']
